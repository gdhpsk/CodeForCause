...
useEffect(() => {
  ...
  return (
    <>
    {width.width < 600 ? <Button color="cyan" onClick={() => setOpen(!open)}>More</Button> : ""}
      <Tabs.Root style={{display: width.width >= 600 ? "block" : "none"}}>
        <Tabs.List>
          ...
          <Tabs.Trigger value="blog"><Link href="/blog">Blog</Link></Tabs.Trigger>
...
<br></br>
      ...
      <Tabs.Root style={{display: width.width < 600 && open ? "block" : "none"}}>
        <Tabs.List style={{display: width.width < 600 && open ? "contents" : "none"}}>
          <Tabs.Trigger value="home"><Link href="/">Home</Link></Tabs.Trigger>
          <Tabs.Trigger value="endorsements"><Link href="/endorsements">Endorsements</Link></Tabs.Trigger>
          <Tabs.Trigger value="subjects"><Link href="/subjects">Subjects</Link></Tabs.Trigger>
            <Tabs.Trigger value="team"><Link href="/team">Team</Link></Tabs.Trigger>
