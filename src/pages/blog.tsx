  ...
  return (
    <>
      <main>
        ...
        <Grid colums="1" width="auto" style={{marginTop: "20px", placeItems: "center"}}>
          <Dialog.Root>
            <Dialog.Trigger>
            ...
            <Dialog.Content style={{ maxWidth: 750 }}>
              <Dialog.Title size="8" weight="bold" as="p" align="center">The Future of STEM Education: Innovations and Trends</Dialog.Title>
        ...
        <Grid colums="1" width="auto" style={{marginTop: "20px", placeItems: "center"}}>
          <Dialog.Root>
            ...
            <Dialog.Content style={{ maxWidth: 750 }}>
              <Dialog.Title size="8" weight="bold" as="p" align="center">Embracing Neurodiversity: Unlocking STEM's Hidden Potential</Dialog.Title>
